...
Factors are used to describe categorical variables with a fixed and known set of __levels__. You can create factors with the base `factor()` or `readr::parse_factor()`:
