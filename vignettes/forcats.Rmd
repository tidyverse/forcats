...
-   An **implicit** missing value does not appear in the levels and `is.na()` reports it as missing.
    This is the usual way to encode a missing value in a factor:
...
-   An **explicit** missing appears in the levels and `is.na()` does not report it as missing.
    This requires a little more work to create:
