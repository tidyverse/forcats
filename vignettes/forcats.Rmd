...
```{r fct-infreq-hair}
#| fig.alt: >
#|   The bar chart of hair color, now ordered so that generally the least
...
## Implicit vs explicit missing levels

There are two ways to represent a missing value in a factor which we call implicit and explicit:
