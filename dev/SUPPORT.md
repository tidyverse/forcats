...
Thanks for using forcats! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/batpigandme/forcats/issues/new).
...
requests](https://github.com/batpigandme/forcats/issues) to make sure
