# Contributing to forcats

This outlines how to propose a change to forcats. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("batpigandme/forcats", fork = TRUE)`.
...
Code of Conduct](https://forcats.tidyverse.org/dev/CODE_OF_CONDUCT.md).
